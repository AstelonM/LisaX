...
import com.lisaxdevelopment.lisax.utils.JsonUtils;
    ...
    public void treat(ExecutionInstance instance) {
        ...
        attachment.retrieveInputStream().thenAccept(inputStream -> {
            ...
            Request request = new Request.Builder()
                    .url("https://vision.googleapis.com/v1/images:annotate?key=" + LisaX.config.getCloudVisionKey())
                    .post(formBody)
                    .build();
            try (Response response = LisaX.HTTP_CLIENT.newCall(request).execute()) {
